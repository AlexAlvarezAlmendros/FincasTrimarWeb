...
| 6 | Simplificación UI | 🔄 In Progress | [06-simplificacion-ui.md](plans/06-simplificacion-ui.md) | Form de crear/editar vivienda mucho más fácil; mensajes y dashboard simples y honestos. 27 tareas priorizadas |
