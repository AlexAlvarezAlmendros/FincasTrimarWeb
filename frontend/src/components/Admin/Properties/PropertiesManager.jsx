...
const useProperties = () => {
    ...
    try {
      ...
      if (filters.status !== 'all') {
        if (filters.status === 'published') {
          filteredProperties = filteredProperties.filter(prop => prop.published);
  ...
  const togglePublishProperty = async (propertyId) => {
    try {
      // Simular llamada API
...
const PropertiesTable = ({ 
  ...
  const getStatusBadge = (property) => {
    if (!property.published) {
      return <span className="status-badge status-draft">Borrador</span>;
    }
  ...
  if (properties.length === 0) {
    return (
      <div className="no-results">
        ...
        <p>Prueba a ajustar los filtros o crear una nueva propiedad.</p>
            ...
            <tr key={property.id} className="property-row">
              ...
              <td className="col-price">
                <div className="price-info">
                  <span className="priceInList">{formatPrice(property.price)}</span>
              ...
              <td className="col-actions">
                <div className="action-buttons">
                  ...
                  <button
                    ...
                    className={`action-btn ${property.published ? 'action-btn--unpublish' : 'action-btn--publish'}`}
...
const PropertiesManager = () => {
  ...
  return (
    <div className="properties-manager">
      <div className="page-header">
        <div className="header-content">
          <h1 className="page-title">Gestión de Viviendas</h1>
          <p className="page-subtitle">
            Administra tu catálogo de propiedades
          </p>
        </div>
      ...
      <div className="content-section">
        ...
        <PropertiesTable
          ...
          loading={loading}
          onTogglePublish={togglePublishProperty}
